...
/// https://tools.ietf.org/html/rfc6901
 struct JSONPointer {
    ...
    /// An internal initalizer for the JSONPointer to force  access to use init(string:).
...
extension JSONPointer {
    ...
    /// - Returns: The escaped string.
     static func escape(_ unescaped: String) -> String {
        var value = unescaped
...
extension JSONPointer: Equatable {
    ...
    /// - Returns: true is the lhs is equal to the rhs.
     static func == (lhs: JSONPointer, rhs: JSONPointer) -> Bool {
