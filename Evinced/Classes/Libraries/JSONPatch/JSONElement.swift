...
extension JSONElement {
    ...
    ///   - operation: The operation to apply.
     mutating func apply(_ operation: JSONPatch.Operation, options: [JSONPatch.ApplyOption] = []) throws {
        do {
            switch operation {
    ...
    ///   - options: The options for applying the patch.
     mutating func apply(patch: JSONPatch,
    ...
    @available(*, deprecated, message: "Use apply(patch: options:) instead")
     mutating func apply(patch: JSONPatch, relativeTo path: JSONPointer) throws {
...
extension JSONElement: Equatable {
    ...
    /// - Returns: true if lhs and rhs are of equivalent types, otherwise false.
     static func equivalentTypes(lhs: JSONElement, rhs: JSONElement) -> Bool {
        switch (lhs, rhs) {
        case (.object, .object),
